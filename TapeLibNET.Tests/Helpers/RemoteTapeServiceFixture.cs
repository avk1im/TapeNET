...
/// </para>
/// </summary>
public sealed class RemoteTapeServiceFixture : IAsyncLifetime, IDisposable
{
...
/// <summary>
/// xUnit collection definition that shares a single <see cref="RemoteTapeServiceFixture"/>
/// across all test classes in the "RemoteTapeService" collection.
/// </summary>
[CollectionDefinition(Name)]
public class RemoteTapeServiceCollection : ICollectionFixture<RemoteTapeServiceFixture>
{
    public const string Name = "RemoteTapeService";
}
