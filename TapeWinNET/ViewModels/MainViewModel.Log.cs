...
public partial class MainViewModel
{
    ...
    /// <summary>Show ErrorException + ImageFailed entries.</summary>
    ...
    /// warning levels first, preserving ErrorException/ImageFailed messages as long as possible.
    ...
    private void PruneLogMessages()
    {
        ...
        // Removal priority: None → Info → Completed → Warning → ImageFailed → ErrorException
