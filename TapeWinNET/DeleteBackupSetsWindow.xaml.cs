...
public partial class DeleteBackupSetsWindow : Window, IHelpPaneHost
{
    ...
    public DeleteBackupSetsWindow(DeleteBackupSetsViewModel viewModel)
    {
        ...
        _help = new DialogHelpPaneController(
            ...
            defaultTopicId: "dialog.delete-backup-sets", helpButton: HelpButton);
    }
    ...
    public string HostName => nameof(DeleteBackupSetsWindow);
