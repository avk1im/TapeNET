...
public class TapeDriveOLD(ILoggerFactory loggerFactory) : IDisposable, IErrorManageable
{
    #region *** Private fields ***

    private SafeFileHandle m_driveHandle = new();

    private readonly ILogger<TapeDriveOLD> m_logger = loggerFactory.CreateLogger<TapeDriveOLD>();
    ...
    public TapeDriveOLD() : this(NullLoggerFactory.Instance) { }
